...
import catchPage from "../../../../../controller/lastPageView.js";
...
const Empleados = () => {
    ...
    const permisos = JSON.parse(localStorage.getItem("userSession")).permissions["Talento Humano"].Empleados;
    ...
    useEffect(async () => {
        ...
        const body = document.querySelector(".empleados");
    ...
    return(
        <Fragment>
            ...
            <section className="empleados">  
                ...
                <div className="empleados__datos">
                    {
                        permissionToBolean(permisos.W) ?
                        <div className="tipos__cabeza">
    
                            <button className="tipos__cabeza__btn" onClick={ funcShowModal }>Crear <FontAwesomeIcon icon={faPlus} /> </button>
