                ...
                <nav className={style.nav}>
                    <ul className={style.nav__ul}>
                        ...
                        <div className={style.nav__contenedorLinks}>
                            <NavLink to='segmentacion' className={({ isActive }) => (isActive ? style.activado : style.nav__a)}>
                                <p className={style.nav__p}> Segmentacion</p>
                            </NavLink>

                            <NavLink to='temporalidad' className={({ isActive }) => (isActive ? style.activado : style.nav__a)}>
                                <p className={style.nav__p}> Temporalidad</p>
                            </NavLink>

                            <NavLink to='variables' className={({ isActive }) => (isActive ? style.activado : style.nav__a)}>
                                <p className={style.nav__p}> Variables</p>
                            </NavLink>

                            <NavLink to='registrar' className={({ isActive }) => (isActive ? style.activado : style.nav__a)}>
                                <p className={style.nav__p}> Registrar</p>
                            </NavLink>
                        </div>
                            ...
                            <li className={style.nav__liLogin}>
                                <p to='/' className={style.dropdown}>
                                    ...
                                    <div className={style.dropdown__content}>
                                        <div><NavLink to="/evaluacion/pendientes" className={({ isActive }) => (isActive ? null : null)}>Evaluacion</NavLink></div>
                                        <div><NavLink to="/indicadores/segmentacion" className={({ isActive }) => (isActive ? null : null)}>Indicadores</NavLink></div>
                                    </div>
                                </p>
                            </li>
                    ...
                    <ul className={style.nav__ul}>
                        ...
                        <div className="">
                            <li className={style.nav__li}>
                                <NavLink to='segmentacion' className={style.nav__a}>
                                <p className={style.nav__p}> <BsClockHistory/></p>
                                </NavLink>
                            </li>
                            <li className={style.nav__li}>
                                <NavLink to='temporalidad' className={style.nav__a}>
                                    <p className={style.nav__p}><FaCheckDouble/></p>
                                </NavLink>
                            </li>
                            <li className={style.nav__li}>
                            <NavLink to='variables' className={style.nav__a}>
                                <p className={style.nav__p}><GoDashboard/></p>
                            </NavLink>
                            </li>
                            <li className={style.nav__li}>
                            <NavLink to='registrar' className={style.nav__a}>
                                <p className={style.nav__p}><GoDashboard/></p>
                            </NavLink>
                            </li>
                        </div>
